...
| Command | Description |
|---------|-------------|
| `npm run server` | Runs the backend on port 5000 with noraider (auto-restart on changes) |
...
- Run: `npm run electron:dev` â€“ starts frontend, backend, and Electron together
