...
const rollLogIndex = source.indexOf("rolls NATURAL 1! Critical Miss!", rollGuardIndex);
...
assert.ok(rollLogIndex > rollGuardIndex, "stale guard should run before NAT 1/NAT 20 roll logs");
