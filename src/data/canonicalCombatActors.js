...
const guardSpear = weapon("weapon.guard-spear", "Spear", "1d6+1", "piercing", { weaponFamily: "spear", deliveryType: "extended-melee", category: "one-handed", handedness: "one-handed", handsRequired: 1, reach: 10, reachFeet: 10, lengthFt: 6, attackBonus: 3, retainedInClinch: true, usableInClinch: false, shieldCompatible: true, shieldCompatibility: true, chargeCapabilities: { canCharge: true, minimumCommittedSteps: 2, maximumStepsPerPulse: 3 }, braceCapabilities: { canBrace: true, interceptionReachHexes: 2 } });
const infantrySpear = weapon("weapon.infantry-spear", "Spear", "1d8+1", "piercing", { weaponFamily: "long-spear", deliveryType: "extended-melee", category: "two-handed", handedness: "two-handed", handsRequired: 2, requiresTwoHands: true, twoHanded: true, reach: 10, reachFeet: 10, lengthFt: 6, attackBonus: 3, retainedInClinch: false, usableInClinch: false, shieldCompatible: false, shieldCompatibility: false, chargeCapabilities: { canCharge: true, minimumCommittedSteps: 2, maximumStepsPerPulse: 3 }, braceCapabilities: { canBrace: true, interceptionReachHexes: 2 } });
...
const crossbow = weapon("weapon.crossbow", "Crossbow", "1d10", "piercing", { type: "ranged", weaponFamily: "crossbow", deliveryType: "projectile", kind: "ranged", attackType: "ranged", category: "ranged", isMelee: false, isRanged: true, handedness: "two-handed", handsRequired: 2, requiresTwoHands: true, twoHanded: true, reach: null, reachFeet: null, lengthFt: null, range: 120, rangeProfile: { normal: 120, long: 480 }, normalRangeFeet: 120, longRangeFeet: 480, ammunition: "bolts", ammunitionType: "bolt", ammunitionPerAttack: 1, reloadRequirement: "one-action", drawRequirement: "none", overwatchCapabilities: { canOverwatch: true, supportedTriggerPolicies: ["enters-guarded-zone", "crosses-guarded-edge", "leaves-cover", "begins-charge"], maximumGuardedHexes: 12, maximumHeldPulses: 6, requiresLoadedState: true }, armorContactProfile: "light-crossbow-bolt", usableInClinch: false, grappleCompatibility: "unavailable", clinchCompatibility: "unavailable", groundedCompatibility: "unavailable", shieldCompatible: false, shieldCompatibility: false });
...
const wildlifeProfile = ({
  defaultMotivations,
  awarenessProfile,
  threatAssessmentProfile,
  quarryProfile,
  escapeProfile,
  defensiveProfile,
  territorialProfile = { enabled: false },
  packProfile = { enabled: false },
  trainingProfile = { trained: false },
  pursuitProfile = { enabled: false },
  recoveryProfile = { enabled: false },
}) => Object.freeze({
  defaultMotivations,
  awarenessProfile,
  threatAssessmentProfile,
...
const perceptionProfile = ({
  sight = "ordinary",
  lowLightSight = "ordinary",
  hearing = "ordinary",
  scent = "ordinary",
  motionSensitivity = "ordinary",
  awarenessDistance = "ordinary",
  identificationDistance = "ordinary",
  scentWindDependency = true,
  ...
  scentWindDependency,
  hearingObstructionDependency,
  authority: "normalized-wildlife-sense-class",
});

const buildOrdinaryFlyingAnimal = ({
  actorKey,
  name,
  species,
  size,
  ...
  carrierProfile = null,
  wildlifeBehaviorProfile = null,
  perceptionProfile: actorPerceptionProfile = null,
  quarryProfile = null,
  ...
  ecologyTags,
  cultureTags: [],
  tags: [...new Set([species, "animal", "flying", ...tags])],
  traitKeys: [...traits],
  traits: [...traits],
  attributes: martialAttributes(scores),
  abilityScores: { ...scores },
  derivedStats: { hp, maxHp: hp, armorClass, movement: groundMovement },
  movementModes: ["ground", "flying"],
  movement: {
    ground: groundMovement,
    flying: flyingMovement,
    modes: ["ground", "flying"],
    groundPace: groundMovement,
    flightPace: flyingMovement,
    burst: flyingMovement * 2,
    runDistance: groundMovement * 2,
    recoveryStep: 5,
    terrainMobility: {},
    mode: "flight",
    bodyPlan: "avian",
    walkFeet: groundMovement,
    flyFeet: flyingMovement,
    turnRadiusClass: "tight",
    canClimb: false,
    canSwim: false,
    canBurrow: false,
    canFly: true,
  ...
  flightProfile: {
    kind: "biological",
    anatomySource: "wings",
    groundMovementFeet: groundMovement,
    flightMovementFeet: flyingMovement,
    takeoffAltitudeFeet,
    maximumAltitudeFeet,
    exactAltitudeAuthority: "flightState.altitudeFeet",
    swoopProfile: null,
    mountedFlight: false,
    magicalFlight: false,
  },
  ...
  perceptionProfile: actorPerceptionProfile,
  quarryProfile,
  companionProfile,
  flightState: {
    mode: "airborne",
    altitudeFeet: takeoffAltitudeFeet,
    altitudeBand: takeoffAltitudeFeet <= 10 ? "low" : "medium",
  ...
  survivalProfile: {
    ...
    permittedOutcomes: ["flee-by-air", "retreat-to-altitude", "land-and-submit", "hold-position", "animal-retreated", "animal-captured"],
  ...
  tacticalProfile: {
    attackSelection: "existing-weighted-legal-actions",
    flightAuthority: "canonical-flight-state",
    swoopAvailable: false,
  },
  behavior: { aggression: 50, caution: 60, instinct: 85, discipline: 20 },
  alignment: null,
...
const hawkTalonRake = animalNatural("hawk-talon-rake", "Talon Rake", "1d4", "slashing", "talon", "talons", {
  attackBonus: 5,
  contactSurface: "talon",
  armorContactProfile: "natural-talon",
  altitudeRequirements: { maximumActorAltitudeFeet: 5 },
  movementRequirements: [],
  airborneCompatibility: "low-flight-only",
  groundedCompatibility: "available",
  usableInClinch: true,
});
const falconTalonRake = animalNatural("falcon-talon-rake", "Talon Rake", "1d4", "slashing", "talon", "talons", {
  attackBonus: 2,
  contactSurface: "talon",
  armorContactProfile: "natural-talon",
  altitudeRequirements: { maximumActorAltitudeFeet: 5 },
...
export const CANONICAL_COMBAT_ACTORS = Object.freeze({
  knight: common({
    ...
    passengerProfile: { allowedRelationshipTypes: ["mounted"], mountFoundationOnly: false },
    riderProfile: {
      mayRide: true,
      permittedMountSizes: ["large"],
      horsemanshipProfile: {
        skillKey: "Horsemanship",
        value: 40,
        authority: "professionSkills.Knight.horsemanship",
      },
      supportedMountedWeapons: ["weapon.long-sword", "weapon.dagger", "weapon.lance"],
      supportedMountedActions: [
        "control-mount", "mounted-walk", "mounted-run", "mounted-charge",
        "mounted-rider-strike", "mounted-rider-ranged-attack",
        "dismount", "emergency-dismount", "recover-mounted-control",
      ],
      saddleRequired: false,
      reinsRequired: false,
      canRideBareback: true,
      mountedDefenseProfile: { authority: "existing-rider-armor-and-shield" },
      forcedDismountProfile: { authority: "canonical-falling-and-stability" },
    },
    aiRole: "melee",
  }),
  ...
  wolf: buildOrdinaryGroundAnimal({
    ...
    perceptionProfile: perceptionProfile({ sight: "ordinary", lowLightSight: "strong", hearing: "strong", scent: "strong", motionSensitivity: "strong", awarenessDistance: "strong" }),
    quarryProfile: { enabled: true, preferredSizeClasses: ["tiny", "small"], maximumEngageSize: "medium", maximumCarrySize: "none", preferredSpeciesTags: ["prey"], acceptableQuarryTags: ["vulnerable", "isolated", "prey"], excludedQuarryTags: ["armored", "prepared-group"], armoredHumanoidsAreQuarry: false, preferredTerrain: ["woodland", "open-country"], pursuitMethods: ["ground-chase", "scent-trail"], captureMethods: ["bite-control"], holdAtCapture: true, carryBehavior: "none", returnBehavior: "none" },
    wildlifeBehaviorProfile: wildlifeProfile({
      defaultMotivations: ["travel", "observe", "hunt"],
      awarenessProfile: { initial: "unaware", escalation: ["suspicious", "alerted", "located-threat"] },
      threatAssessmentProfile: { avoidArmoredGroups: true, vulnerableQuarryRequiresIsolation: true, protectedResponse: "defend-territory" },
      quarryProfile: "actor.quarryProfile",
      escapeProfile: { preferred: true, stopPursuitWhenRiskExceedsMotivation: true },
      defensiveProfile: { corneredResponses: ["defend-self", "create-escape-opening"] },
      territorialProfile: { enabled: true, protectedTypes: ["den", "pack"] },
      packProfile: { enabled: true, authority: "explicit-group-metadata", militaryTactics: false },
      pursuitProfile: { enabled: true, methods: ["scent", "hearing", "sight"], abandonWhenRiskHigh: true },
      recoveryProfile: { enabled: false },
    }),
  }),
  boar: buildOrdinaryGroundAnimal({
    ...
    source: "public-actor", sourceLabel: "Public Actor",
    perceptionProfile: perceptionProfile({ sight: "ordinary", hearing: "strong", scent: "strong", motionSensitivity: "ordinary" }),
    quarryProfile: { enabled: false },
    wildlifeBehaviorProfile: wildlifeProfile({
      defaultMotivations: ["forage", "escape"],
      awarenessProfile: { initial: "unaware", escalation: ["suspicious", "alerted", "located-threat"] },
      threatAssessmentProfile: { defaultHunterClassification: "avoid", corneredClassification: "immediate-threat" },
      quarryProfile: "actor.quarryProfile",
      escapeProfile: { preferred: true, preferredCover: "dense", stopPursuitWhenEscapeOpens: true },
      defensiveProfile: { corneredResponses: ["defend-self", "tusk-charge"], chargeProfileKey: "natural.boar-tusk-charge", freeChargeAfterWound: false },
      territorialProfile: { enabled: true, protectedTypes: ["young"] },
      pursuitProfile: { enabled: false },
      recoveryProfile: { enabled: false },
    }),
  }),
  mastiff: buildOrdinaryGroundAnimal({
    ...
    perceptionProfile: perceptionProfile({ sight: "ordinary", hearing: "strong", scent: "strong", motionSensitivity: "strong" }),
    quarryProfile: { enabled: true, preferredSizeClasses: ["tiny", "small", "medium"], maximumEngageSize: "medium", maximumCarrySize: "none", preferredSpeciesTags: ["tracked-quarry"], acceptableQuarryTags: ["commanded-quarry"], excludedQuarryTags: ["handler", "ally"], armoredHumanoidsAreQuarry: false, pursuitMethods: ["scent-trail", "ground-chase"], captureMethods: ["bite-control"], holdAtCapture: true, carryBehavior: "none", returnBehavior: "return-to-handler" },
    companionProfile: { enabled: true, companionTypes: ["tracking-dog", "guard-dog"], communicationMethods: ["voice", "gesture", "scent-cue"], recallMethod: "voice", routineCommands: ["search", "pursue", "abort", "hold", "return"], pressureUsesExistingControl: true },
    wildlifeBehaviorProfile: wildlifeProfile({
      defaultMotivations: ["follow-command", "protect-food"],
      awarenessProfile: { initial: "alerted", escalation: ["located-threat", "engaged"] },
      threatAssessmentProfile: { handlerProtectionOverridesWildPredation: true },
      quarryProfile: "actor.quarryProfile",
      escapeProfile: { preferredWhenUncommandedAndInjured: true },
      defensiveProfile: { corneredResponses: ["protect-handler", "defend-self"] },
      trainingProfile: { trained: true, roles: ["guard", "track", "flush", "chase", "hold", "protect-handler", "return"], routineCommandRollRequired: false },
      pursuitProfile: { enabled: true, methods: ["scent", "hearing"], requiresCommandOrMotivation: true },
      recoveryProfile: { enabled: false },
    }),
  }),
  warhorse: buildOrdinaryGroundAnimal({
    ...
    survivalProfile: { mountedCombatSupported: true }, tacticalProfile: { riderState: "none", bardingState: "none" },
    carrierProfile: {
      maximumLoad: 300,
      authority: "legacy-movement.mountMovement.warHorse.carryingCapacity",
      allowedRelationshipTypes: ["mounted"],
      coordinatedMountedCombatSupported: true,
    },
    mountProfile: {
      mayServeAsMount: true,
      permittedRiderSizes: ["small", "medium"],
      maximumRiders: 1,
      carryingCapacity: 300,
      equipmentCapacity: 300,
      groundMovementSupported: true,
      flightSupported: false,
      controlProfile: {
        intelligenceClass: "ordinary-animal",
        trainingClass: "combat-trained",
        defaultControlType: "rider-controlled",
        mayRefuseCommands: true,
        mayPanic: true,
        requiresHorsemanship: true,
      },
      equipmentSlots: {
        saddle: { supported: true, equippedProfile: null },
        bridle: { supported: true, equippedProfile: null },
        reins: { supported: true, equippedProfile: null },
        harness: { supported: true, equippedProfile: null },
        barding: { supported: true, equippedProfile: null, statisticsAuthority: null },
      },
      mountedActions: ["mounted-walk", "mounted-run", "mount-natural-attack"],
      riderActionsSupported: ["mounted-rider-strike", "mounted-rider-ranged-attack"],
      coordinatedActions: ["mounted-charge"],
      dismountProfile: { authority: "canonical-carrier-link" },
      forcedDismountProfile: { authority: "canonical-falling-and-stability" },
    },
    perceptionProfile: perceptionProfile({ sight: "strong", hearing: "strong", scent: "ordinary", motionSensitivity: "strong", awarenessDistance: "strong" }),
    quarryProfile: { enabled: false },
    wildlifeBehaviorProfile: wildlifeProfile({
      defaultMotivations: ["forage", "rest", "travel", "follow-command"],
      awarenessProfile: { initial: "suspicious", escalation: ["alerted", "located-threat"] },
      threatAssessmentProfile: { quarryBehaviorDisabled: true, threatSensitive: true },
      quarryProfile: "actor.quarryProfile",
      escapeProfile: { preferredWhenUncontrolled: true, seekHerdOrAllies: true },
      defensiveProfile: { pressureResponses: ["rear", "hesitate", "refuse", "bolt", "kick"], authority: "mounted-control-and-animal-morale" },
      trainingProfile: { trained: true, roles: ["mount", "follow", "defend"], routineCommandRollRequired: false },
      pursuitProfile: { enabled: false },
      recoveryProfile: { enabled: false },
    }),
  }),
  bear: buildOrdinaryGroundAnimal({
    ...
    perceptionProfile: perceptionProfile({ sight: "ordinary", hearing: "ordinary", scent: "strong", motionSensitivity: "ordinary", awarenessDistance: "strong" }),
    quarryProfile: { enabled: false },
    wildlifeBehaviorProfile: wildlifeProfile({
      defaultMotivations: ["forage", "observe", "avoid"],
      awarenessProfile: { initial: "unaware", escalation: ["suspicious", "alerted", "located-threat"] },
      threatAssessmentProfile: { defaultHunterClassification: "observe", defensiveEscalation: true },
      quarryProfile: "actor.quarryProfile",
      escapeProfile: { preferredWhenUnmotivated: true, stopPursuitWhenThreatRetreats: true },
      defensiveProfile: { corneredResponses: ["threat-display", "defend-self"], pursueOnlyWhileMotivated: true },
      territorialProfile: { enabled: true, protectedTypes: ["food", "young"] },
      packProfile: { enabled: false },
      pursuitProfile: { enabled: false },
      recoveryProfile: { enabled: false },
    }),
  ...
  "giant-rat": buildOrdinaryGroundAnimal({
    ...
    source: "public-enemy", sourceLabel: "Public Enemy",
    tacticalProfile: { packCapable: true },
    perceptionProfile: perceptionProfile({ sight: "weak", lowLightSight: "strong", hearing: "strong", scent: "strong", motionSensitivity: "ordinary", awarenessDistance: "ordinary" }),
    quarryProfile: { enabled: false },
    wildlifeBehaviorProfile: wildlifeProfile({
      defaultMotivations: ["forage", "hide", "escape"],
      awarenessProfile: { initial: "suspicious", escalation: ["alerted", "located-threat"] },
      threatAssessmentProfile: { avoidArmoredThreatsWhenEscapeExists: true },
      quarryProfile: "actor.quarryProfile",
      escapeProfile: { preferred: true, preferredCover: "small-or-protected-routes", stopPursuitWhenEscapeOpens: true },
      defensiveProfile: { corneredResponses: ["defend-self", "create-escape-opening"] },
      packProfile: { enabled: true, authority: "explicit-group-metadata", militaryTactics: false },
      pursuitProfile: { enabled: false },
      recoveryProfile: { enabled: false },
  ...
  hawk: buildOrdinaryFlyingAnimal({
    actorKey: "hawk", name: "Hawk", species: "hawk", size: "small", role: "aerial-scout",
    hp: 5, armorClass: 14, groundMovement: 10, flyingMovement: 60, staminaMaximum: 8,
    scores: { strength: 5, dexterity: 17, constitution: 8, intelligence: 3, wisdom: 14, charisma: 6 },
    ...
    perceptionProfile: perceptionProfile({ sight: "exceptional", lowLightSight: "ordinary", hearing: "ordinary", scent: "weak", motionSensitivity: "exceptional", awarenessDistance: "exceptional", identificationDistance: "strong" }),
    quarryProfile: { enabled: true, preferredSizeClasses: ["tiny"], maximumEngageSize: "tiny", maximumCarrySize: "tiny", preferredSpeciesTags: ["small-bird", "rodent", "prey"], acceptableQuarryTags: ["tiny-prey"], excludedQuarryTags: ["humanoid", "armored", "large"], armoredHumanoidsAreQuarry: false, preferredTerrain: ["open", "woodland-edge"], pursuitMethods: ["visual-flight"], captureMethods: ["talon-control"], holdAtCapture: true, carryBehavior: "capacity-only", returnBehavior: "perch-or-handler-when-trained" },
    companionProfile: { enabled: true, companionTypes: ["hunting-raptor"], communicationMethods: ["gesture", "lure", "glove"], recallMethod: "lure-or-glove", routineCommands: ["release", "search", "circle", "gain-altitude", "pursue", "abort", "hold", "return", "perch", "release-quarry"], pressureUsesExistingControl: true },
    wildlifeBehaviorProfile: wildlifeProfile({
      defaultMotivations: ["observe", "hunt", "escape"],
      awarenessProfile: { initial: "alerted", dominantSense: "sight" },
      threatAssessmentProfile: { avoidGroundedMelee: true, armoredHumanoidsAreThreats: true },
      quarryProfile: "actor.quarryProfile",
      escapeProfile: { preferredWhenInjured: true, method: "retreat-to-altitude" },
      defensiveProfile: { corneredResponses: ["defend-self", "escape"], groundedMeleeDisfavored: true },
      trainingProfile: { trained: false, optionalCompanionLink: true },
      pursuitProfile: { enabled: true, methods: ["visual-flight"], abandonPoorApproach: true },
      recoveryProfile: { enabled: true, carryToHandlerRequired: false },
    }),
  }),
  falcon: buildOrdinaryFlyingAnimal({
    actorKey: "falcon", name: "Falcon", species: "falcon", size: "small", role: "trained-hunting-bird",
    hp: 5, armorClass: 14, groundMovement: 0, flyingMovement: 60, staminaMaximum: 10,
    scores: { strength: 5, dexterity: 17, constitution: 10, intelligence: 3, wisdom: 9, charisma: 6 },
    ...
    perceptionProfile: perceptionProfile({ sight: "exceptional", lowLightSight: "ordinary", hearing: "ordinary", scent: "weak", motionSensitivity: "exceptional", awarenessDistance: "exceptional", identificationDistance: "strong" }),
    quarryProfile: { enabled: true, preferredSizeClasses: ["tiny"], maximumEngageSize: "tiny", maximumCarrySize: "tiny", preferredSpeciesTags: ["small-bird", "rodent", "prey"], acceptableQuarryTags: ["tiny-prey"], excludedQuarryTags: ["humanoid", "armored", "large"], armoredHumanoidsAreQuarry: false, preferredTerrain: ["open", "woodland-edge"], pursuitMethods: ["visual-flight"], captureMethods: ["talon-control"], holdAtCapture: true, carryBehavior: "capacity-only", returnBehavior: "perch-or-handler" },
    companionProfile: { enabled: true, companionTypes: ["hunting-raptor"], communicationMethods: ["gesture", "lure", "glove"], recallMethod: "lure-or-glove", routineCommands: ["release", "search", "circle", "gain-altitude", "pursue", "abort", "hold", "return", "perch", "release-quarry"], pressureUsesExistingControl: true },
    wildlifeBehaviorProfile: wildlifeProfile({
      defaultMotivations: ["follow-command", "observe", "hunt"],
      awarenessProfile: { initial: "alerted", dominantSense: "sight" },
      threatAssessmentProfile: { avoidGroundedMelee: true, armoredHumanoidsAreThreats: true },
      quarryProfile: "actor.quarryProfile",
      escapeProfile: { preferredWhenInjured: true, method: "retreat-to-altitude" },
      defensiveProfile: { corneredResponses: ["defend-self", "escape"], groundedMeleeDisfavored: true },
      trainingProfile: { trained: true, roles: ["search", "pursue", "hold", "return", "perch"], routineCommandRollRequired: false },
      pursuitProfile: { enabled: true, methods: ["visual-flight"], abandonPoorApproach: true },
      recoveryProfile: { enabled: true, carryToHandlerRequired: false },
    }),
  }),
...
export const CANONICAL_FLYING_ANIMAL_KEYS = Object.freeze(["hawk", "falcon"]);
