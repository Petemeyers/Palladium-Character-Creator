...
export const CANONICAL_COMBAT_ACTORS = Object.freeze({
  knight: common({
    ...
    alignment: "Scrupulous", alignmentBehaviorMappingKey: "scrupulous", behaviorProfileKey: "knight-scrupulous", behavior: { aggression: 55, caution: 60, loyalty: 75, instinct: 35, mercy: 82, cruelty: 8, greed: 22, honor: 80, pride: 48, discipline: 72 },
    moraleProfile: { state: "steady", routBehavior: "organized-withdrawal", surrenderEligible: true, terminalEscapeBehavior: "map-boundary" }, surrenderProfile: { mayOfferSurrender: true, mayAcceptSurrender: true, behaviorProfile: "honorable-merciful", prisonerPreference: "take-prisoner", executionPreference: "avoid", alignmentBehaviorMappingKey: "scrupulous" },
  ...
  "goblin-warrior": common({
    ...
    alignment: "Anarchist", alignmentBehaviorMappingKey: "anarchist", behaviorProfileKey: "goblin-opportunist", behavior: { aggression: 48, caution: 70, loyalty: 42, instinct: 65, mercy: 38, cruelty: 34, greed: 68, honor: 28, pride: 38, discipline: 34, prefersFlanking: true, prefersAssistance: true },
    moraleProfile: { state: "steady", routBehavior: "flee-or-bargain", surrenderEligible: true, terminalEscapeBehavior: "map-boundary" }, surrenderProfile: { mayOfferSurrender: true, mayAcceptSurrender: true, behaviorProfile: "opportunistic", prisonerPreference: "ransom-or-confiscate", executionPreference: "circumstantial", alignmentBehaviorMappingKey: "anarchist" },
  ...
  minotaur: common({
    ...
    alignment: "Unprincipled", alignmentBehaviorMappingKey: "unprincipled", behaviorProfileKey: "minotaur-proud-brute", behavior: { aggression: 82, caution: 28, loyalty: 45, instinct: 72, mercy: 34, cruelty: 38, greed: 30, honor: 42, pride: 82, discipline: 50 },
    moraleProfile: { state: "steady", routBehavior: "proud-withdrawal", surrenderEligible: true, terminalEscapeBehavior: "map-boundary" }, surrenderProfile: { mayOfferSurrender: true, mayAcceptSurrender: true, behaviorProfile: "proud-pragmatist", prisonerPreference: "circumstantial", executionPreference: "circumstantial", alignmentBehaviorMappingKey: "unprincipled" },
