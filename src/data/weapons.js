export const weapons = [
  ...
  { name: "Spear", damage: "1d8", type: "weapon", category: "two-handed", weight: 5, price: 18, reach: 6, range: 30, rateOfFire: 1, ammunition: null, strengthRequired: 8, chargeCapabilities: { canCharge: true, minimumCommittedSteps: 2, maximumStepsPerPulse: 3 }, braceCapabilities: { canBrace: true, interceptionReachHexes: 2 }, notes: "Controls distance." },
  { name: "Pike", damage: "1d10", type: "weapon", category: "two-handed", weight: 12, price: 35, reach: 10, range: null, rateOfFire: null, ammunition: null, strengthRequired: 11, chargeCapabilities: { canCharge: true, minimumCommittedSteps: 2, maximumStepsPerPulse: 3 }, braceCapabilities: { canBrace: true, interceptionReachHexes: 2 }, notes: "Long formation weapon." },
  { name: "Halberd", damage: "1d10", type: "weapon", category: "two-handed", weight: 9, price: 45, reach: 8, range: null, rateOfFire: null, ammunition: null, strengthRequired: 11, chargeCapabilities: { canCharge: true, minimumCommittedSteps: 2, maximumStepsPerPulse: 3 }, braceCapabilities: { canBrace: true, interceptionReachHexes: 2 }, notes: "Hooking and chopping polearm." },
  { name: "Longbow", damage: "1d8", type: "weapon", category: "ranged", weight: 3, price: 75, reach: null, range: 150, rateOfFire: 1, ammunition: "Arrow", strengthRequired: 12, overwatchCapabilities: { canOverwatch: true, supportedTriggerPolicies: ["enters-guarded-zone", "crosses-guarded-edge", "leaves-cover", "begins-charge"], maximumGuardedHexes: 12, maximumHeldPulses: 6 }, notes: "Powerful trained bow." },
  { name: "Crossbow", damage: "1d10", type: "weapon", category: "ranged", weight: 7, price: 90, reach: null, range: 120, rateOfFire: 1, ammunition: "Bolt", strengthRequired: 8, overwatchCapabilities: { canOverwatch: true, supportedTriggerPolicies: ["enters-guarded-zone", "crosses-guarded-edge", "leaves-cover", "begins-charge"], maximumGuardedHexes: 12, maximumHeldPulses: 6, requiresLoadedState: true }, notes: "Strong ranged weapon with slower reload." },
