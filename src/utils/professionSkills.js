/**
 * profession Skill Tables & Modifiers (Medieval Combat Simulator)
 *
 * Base skill percentages for each profession, plus stat-based modifiers.
...
// ========== profession BASE SKILL TABLES ==========

export const professionSkillTables = {
  // ========== MEN OF TRAINING ==========
  Duelist: {
    readWrite: 30,
    loreTraining: 35,
 ...
 */
export function buildSkillSet(profession, iq, pp, me, level = 1) {
  const baseSkills = professionSkillTables[profession] || {};
  ...
  Object.entries(baseSkills).forEach(([skill, base]) => {
    ...
    const total = getSkillPercentage(character, skill, 'profession');
